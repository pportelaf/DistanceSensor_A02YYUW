...
enum {
    DistanceSensor_A02YYUW_MEASSURE_STATUS_OK = 0,
    DistanceSensor_A02YYUW_MEASSURE_STATUS_ERROR_CHECK_SUM = -1,
    DistanceSensor_A02YYUW_MEASSURE_STATUS_ERROR_MAX_LIMIT = -2,
    DistanceSensor_A02YYUW_MEASSURE_STATUS_ERROR_MIN_LIMIT = -3,
    DistanceSensor_A02YYUW_MEASSURE_STATUS_ERROR_SERIAL = -4
};

typedef int DistanceSensor_A02YYUW_MEASSURE_STATUS;
...
class DistanceSensor_A02YYUW {
	public:
		...
		DistanceSensor_A02YYUW_MEASSURE_STATUS meassure();
